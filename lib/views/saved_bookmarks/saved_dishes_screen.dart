          ...
          : savedDeals.isEmpty
              ? Center(
                  child: Column(
                    ...
                    children: const [
                      Icon(Icons.favorite_border, size: 56, color: AppColors.textLightGrey),
                      SizedBox(height: 14),
                      Text(
                        'Keine gespeicherten Gerichte vorhanden.',
                        style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: AppColors.textGrey),
                      ),
                      SizedBox(height: 6),
                      Text(
                        'Tippen Sie auf das Herz-Symbol, um Gerichte zu speichern.',
                        style: TextStyle(fontSize: 12.5, color: AppColors.textLightGrey),
                      ),
                    ],
                  ),
                )
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        const Icon(Icons.location_on, color: AppColors.badgeRed, size: 12),
